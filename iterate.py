...
N_ch = 1; # one pair of hot and cold is one ch
...
T_hot_in= 665  # Hot inlet temperature in Kelvin
T_cold_in=416  # Cold inlet temperature in Kelvin
P_hot_in= 9000000   #Hot inlet pressure in Pa
P_cold_in= 21000000 # Cold inlet pressure in Pa
...
print(Told)
count=0
while(res>0.001): #abs(np.max(T-Told))>0.1
...
print(res)
print("final ehin ehout ecin ecout (j/kg)")
print(ehin);print(ehout);print(ecin);print(ecout)
